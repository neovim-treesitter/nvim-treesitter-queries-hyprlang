# nvim-treesitter-queries-hyprlang

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-hyprlang/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-hyprlang/actions/workflows/validate.yml)

Neovim tree-sitter queries for **hyprlang**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-hyprlang",
...
- [ ] Changes are scoped to `hyprlang` — do not include files for other languages
